...
#cd /exports/slc5/CMSSW/Development/Users/Derek/Nov23/CMSSW_4_4_0/src
#cd /exports/slc5/CMSSW/Development/Users/Derek/Feb20/CMSSW_4_4_0/src
...
# create a cfg so users can run from raw again from dat file
cat $BASEDIR/scripts/sourcefromdat_template_cfg.py \                                                                                                                                                                                       
  | sed 's,RUNNUMBER,'$RUNNUMBER',g' \                                                                                                                                                                                                       
  | sed 's,DBPART,'$DBPARTITIONNAME',g' \                                                                                                                                                                                                    
  > $SCRATCH/sourcefromdat_${RUNNUMBER}_cfg.py
for file in `ls USC*storageManager*dat` ; do
  echo "process.source.fileNames.extend(cms.untracked.vstring('file:`basename $file .dat`'))" >> sourcefromdat_${RUNNUMBER}_cfg.py
done
