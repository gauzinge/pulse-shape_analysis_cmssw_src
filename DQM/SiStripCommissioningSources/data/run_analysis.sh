...
function cleanup() {
    #remove lock file
    if [ -f $DATALOC/lock_$RUNNUMBER.txt ]; then
	rm -f $DATALOC/lock_$RUNNUMBER.txt
    fi
}
# clean up if killed
...
if [ -f $DATALOC/lock_$RUNNUMBER.txt ]; then
    echo "Analysis is already running for this run number! Check /opt/cmssw/Data/lock_RUNNUMBER.txt"
    exit 0
fi

echo "Running analysis script ..." > $DATALOC/lock_$RUNNUMBER.txt
...
LD_LIBRARY_PATH=/raid/cmssw/Development/Derek/CMSSW_6_1_0_pre1/lib/slc6_amd64_gcc462:/raid/development/tkonline/lib:/opt/offline/slc6_amd64_gcc462/cms/cmssw/CMSSW_6_1_0_pre1/lib/slc6_amd64_gcc462/:/opt/offline/slc6_amd64_gcc462/cms/cmssw/CMSSW_6_1_0_pre1/external/slc6_amd64_gcc462/lib/:/opt/offline/slc6_amd64_gcc462/external/gcc/4.6.2/lib64:/opt/offline/slc6_amd64_gcc462/external/gcc/4.6.2/lib:/lib64:/lib:/usr/lib64:/usr/lib:/opt/cmsswLocal/lib
...
rm $DATALOC/lock_$RUNNUMBER.txt
