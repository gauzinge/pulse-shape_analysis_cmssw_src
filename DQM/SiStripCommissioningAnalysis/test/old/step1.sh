...
for i in `nsls /castor/cern.ch/user/d/dstrom/SiStrip2011/CalibScanAUG29/TECM/${1} | grep SiStripCommissioningSource`; { echo -n "-M /castor/cern.ch/user/d/dstrom/SiStrip2011/CalibScanAUG29/TECM/${1}/$i "; } | xargs -n1000 -s129000 stager_get -U CDrun${1}
